$(document).ready(function() {
    ...
    $('[data-user]').click(function(e) {
        ...
        getdetails( $(this).data('user')).done(function(response) {
            ...
            if (response.success) {
                ...
                $.each(response.data.users, function(key, value) {
                    ...
                    output += "<div id='usuarios'><h2>Detalles del usuario " + value['ID'] + "</h2>";
     ...
     $('[data-insert]').click(function(e) {
         e.preventDefault();
         $("#response-container").html("<p>Insertando...</p>");
